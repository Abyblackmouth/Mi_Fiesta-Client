     ...
     <div className="w-2/3 overflow-hidden flex ">
      <article className={clsx( //'w-60 px-8 ',  'mx-5',
          ...
          <div className={clsx( 'my-5' )}>
              ...
              <Subtitle>Mis Respuestas</Subtitle>
          ...
          <div class="p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
              ...
              <h5 class="mb-2  font-semibold tracking-tight text-gray-900 dark:text-white">Fecha: 25/09/2022</h5>
              ...
              <p class="mb-3 font-normal text-gray-500 dark:text-gray-400">
                Pastel de 2 pisos para  50 personas de tematica de Pokemon  ...
              </p>
              <p class="mb-3 font-normal text-gray-500 dark:text-gray-400">
              Fecha de entrega:   Sábado 10/sep/22
                  Hora:
